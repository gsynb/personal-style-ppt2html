...
- Use image generation only for non-factual reusable assets such as restrained cover backgrounds, subtle lattice/network motifs, chapter dividers, blank module panels, or decorative flow-arrow sheets.
